...
export default function Navbar() {
  ...
  if (!isClient || pathname?.startsWith('/auth/')) {
    return null;
  }
  ...
  // Base nav items; inject Chat only if signed in
  const navItems = [
    ...
    <nav className="bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          {/* Desktop Auth / Chat Buttons */}
          <div className="hidden md:flex items-center space-x-2">
            {user ? (
              <>
                <Link
                  href="/chat"
                  className="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md shadow-sm"
                >
